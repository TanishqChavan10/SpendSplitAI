...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "min-h-screen bg-linear-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800 relative flex items-start w-full justify-center overflow-hidden",
        className
      )}
    >
      {beams.map((beam) => (
